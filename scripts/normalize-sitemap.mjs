...
const urls=[...new Set([...xml.matchAll(/<loc>([^<]+)<\/loc>/g)].map(match=>match[1]).concat('https://tech-from-here-fashion-week.vercel.app/rights/media-provenance'))]
  .filter(url=>new URL(url).pathname!=='/excavation');
